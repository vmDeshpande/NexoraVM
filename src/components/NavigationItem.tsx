...
import type { NavigationIcon, NavigationView } from "../types/navigation";

const icons: Record<NavigationIcon, ReactElement> = {
  dashboard: (
...
export function NavigationItem({
  ...
  return (
    ...
    >
      <span className="navigation-item__icon">{icons[icon]}</span>
